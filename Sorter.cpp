...
void Sorter::collectEvaluationsOct(CkReductionMsg* m) {
  ...
  if (joinThreshold == 0) {
    ...
    joinThreshold = 1.25 * total_load / numChares;
    splitThreshold = 1.5 * total_load / numChares;
  }
