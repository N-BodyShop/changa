...
function snii_mglin_K01, m
  return,lin_K01(m,0.01,-0.1)
end
function snii_silin_K01, m
  return,lin_K01(m,0.01,-0.1)
end
function snii_nelin_K01, m
  return,lin_K01(m,0.08,-2.0)
end
function snii_clin_K01, m
  return,lin_K01(m,0.01,0.0)
end
function snii_nlin_K01, m
  return,lin_K01(m,3.67e-3,-6.7e-3)
end
function agb_oxlin_K01, m
  return,lin_K01(m,0.0,0.001)
end
