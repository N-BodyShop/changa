...
// local
#define NODE_INTERACTIONS_PER_REQUEST_L 3.0
#define PART_INTERACTIONS_PER_REQUEST_L 3.0
// remote, no-resume
#define NODE_INTERACTIONS_PER_REQUEST_RNR 3.0
#define PART_INTERACTIONS_PER_REQUEST_RNR 3.0
// remote, resume
#define NODE_INTERACTIONS_PER_REQUEST_RR 3.0
#define PART_INTERACTIONS_PER_REQUEST_RR 3.0
